...
def render_test_case(op_name, spec, idx, helpers=None):
    ...
    # 形状来源：优先从 ensure_shapes 读取 x1/x2/out
    ...
    # 按 test_0 的顺序：expand_x, expert_ids, expand_idx, ep_send_counts, expert_scales, tp_send_counts
    lines.append("                        .InputShapes(<LB>&expand_x_shape, &expert_ids_shape, &expand_idx_shape, &ep_send_counts_shape, &expert_scales_shape, &tp_send_counts_shape<RB>)")
