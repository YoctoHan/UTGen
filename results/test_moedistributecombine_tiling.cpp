...
TEST_F(MoeDistributeCombineTiling, moe_distribute_combine_basic_large) {
    ...
    gert::StorageShape expert_ids_shape = {{1024, 8}, {1024, 8}};
    gert::StorageShape expand_idx_shape = {{8192}, {8192}};
    gert::StorageShape ep_send_counts_shape = {{256}, {256}};
    gert::StorageShape expert_scales_shape = {{1024, 8}, {1024, 8}};
    gert::StorageShape tp_send_counts_shape = {{1}, {1}};
...
TEST_F(MoeDistributeCombineTiling, moe_distribute_combine_tp_enabled) {
    // 1. Setup interfaces
    std::string op_type("MoeDistributeCombine");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    gert::StorageShape expert_ids_shape = {{512, 4}, {512, 4}};
    gert::StorageShape expand_idx_shape = {{2048}, {2048}};
    gert::StorageShape ep_send_counts_shape = {{64}, {64}};
    gert::StorageShape expert_scales_shape = {{512, 4}, {512, 4}};
...
TEST_F(MoeDistributeCombineTiling, moe_distribute_combine_shared_expert) {
    ...
    gert::StorageShape expert_ids_shape = {{256, 2}, {256, 2}};
    gert::StorageShape expand_idx_shape = {{512}, {512}};
    gert::StorageShape ep_send_counts_shape = {{128}, {128}};
    gert::StorageShape expert_scales_shape = {{256, 2}, {256, 2}};
    gert::StorageShape tp_send_counts_shape = {{1}, {1}};
...
TEST_F(MoeDistributeCombineTiling, moe_distribute_combine_max_bs) {
    // 1. Setup interfaces
    std::string op_type("MoeDistributeCombine");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    gert::StorageShape ep_send_counts_shape = {{144}, {144}};
...
TEST_F(MoeDistributeCombineTiling, moe_distribute_combine_min_bs) {
    // 1. Setup interfaces
    std::string op_type("MoeDistributeCombine");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(MoeDistributeCombineTiling, moe_distribute_combine_boundary_k) {
    // 1. Setup interfaces
    std::string op_type("MoeDistributeCombine");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(MoeDistributeCombineTiling, moe_distribute_combine_boundary_h) {
    // 1. Setup interfaces
    std::string op_type("MoeDistributeCombine");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(MoeDistributeCombineTiling, moe_distribute_combine_david_scenario) {
    // 1. Setup interfaces
    std::string op_type("MoeDistributeCombine");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
