...
TEST_F(MatmulAllReduceTiling, matmul_all_reduce_test_tiling_float16_1) {
    ...
    gert::StorageShape x1_shape = {{512, 12288}, {512, 12288}};
    gert::StorageShape x2_shape = {{12288, 3904}, {12288, 3904}};
    gert::StorageShape bias_shape = {{3904}, {3904}};
    gert::StorageShape output_shape = {{512, 3904}, {512, 3904}};
...
TEST_F(MatmulAllReduceTiling, matmul_all_reduce_test_tiling_float16_2) {
    ...
    gert::StorageShape x2_shape = {{4096, 1536}, {4096, 1536}};
    gert::StorageShape bias_shape = {{1536}, {1536}};
    gert::StorageShape output_shape = {{2048, 1536}, {2048, 1536}};
    // 5. Build fake context
    string group("group");
    string reduce_op("sum");
    auto holder = gert::TilingContextFaker()
...
TEST_F(MatmulAllReduceTiling, matmul_all_reduce_test_tiling_float16_l2cache) {
    // 1. Setup interfaces
    std::string op_type("MatmulAllReduce");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    auto ws_size = reinterpret_cast<gert::ContinuousVector*>(workspace_size_holer.get());
    // 4. Define input/output shapes (dims 与 storage_dims 对齐)
    gert::StorageShape x1_shape = {{8192, 5120}, {8192, 5120}};
    gert::StorageShape x2_shape = {{5120, 12288}, {5120, 12288}};
    gert::StorageShape bias_shape = {{12288}, {12288}};
...
TEST_F(MatmulAllReduceTiling, matmul_all_reduce_test_tiling_large_m) {
    // 1. Setup interfaces
    std::string op_type("MatmulAllReduce");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    auto ws_size = reinterpret_cast<gert::ContinuousVector*>(workspace_size_holer.get());
    // 4. Define input/output shapes (dims 与 storage_dims 对齐)
    gert::StorageShape x1_shape = {{32768, 4096}, {32768, 4096}};
    gert::StorageShape x2_shape = {{4096, 2048}, {4096, 2048}};
    gert::StorageShape bias_shape = {{2048}, {2048}};
    gert::StorageShape output_shape = {{32768, 2048}, {32768, 2048}};
    // 5. Build fake context
    string group("group");
    string reduce_op("sum");
    auto holder = gert::TilingContextFaker()
...
TEST_F(MatmulAllReduceTiling, matmul_all_reduce_test_tiling_large_k) {
    // 1. Setup interfaces
    std::string op_type("MatmulAllReduce");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    auto ws_size = reinterpret_cast<gert::ContinuousVector*>(workspace_size_holer.get());
    // 4. Define input/output shapes (dims 与 storage_dims 对齐)
    gert::StorageShape x1_shape = {{1024, 16384}, {1024, 16384}};
...
TEST_F(MatmulAllReduceTiling, matmul_all_reduce_test_tiling_large_n) {
    // 1. Setup interfaces
    std::string op_type("MatmulAllReduce");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    gert::StorageShape bias_shape = {{16384}, {16384}};
...
TEST_F(MatmulAllReduceTiling, matmul_all_reduce_test_tiling_small_shape) {
    // 1. Setup interfaces
    std::string op_type("MatmulAllReduce");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(MatmulAllReduceTiling, matmul_all_reduce_test_tiling_boundary_min) {
    // 1. Setup interfaces
    std::string op_type("MatmulAllReduce");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    auto ws_size = reinterpret_cast<gert::ContinuousVector*>(workspace_size_holer.get());
    // 4. Define input/output shapes (dims 与 storage_dims 对齐)
    gert::StorageShape x1_shape = {{1, 1}, {1, 1}};
    gert::StorageShape x2_shape = {{1, 1}, {1, 1}};
    gert::StorageShape bias_shape = {{1}, {1}};
...
TEST_F(MatmulAllReduceTiling, matmul_all_reduce_test_tiling_empty_tensor) {
    // 1. Setup interfaces
    std::string op_type("MatmulAllReduce");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    auto ws_size = reinterpret_cast<gert::ContinuousVector*>(workspace_size_holer.get());
    // 4. Define input/output shapes (dims 与 storage_dims 对齐)
    gert::StorageShape x1_shape = {{0, 12288}, {0, 12288}};
    gert::StorageShape x2_shape = {{12288, 3904}, {12288, 3904}};
    gert::StorageShape bias_shape = {{3904}, {3904}};
    gert::StorageShape output_shape = {{0, 3904}, {0, 3904}};
    // 5. Build fake context
    string group("group");
    string reduce_op("sum");
    auto holder = gert::TilingContextFaker()
