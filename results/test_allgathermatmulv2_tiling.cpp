...
TEST_F(AllGatherMatmulV2Tiling, all_gather_matmul_v2_test_basic_small_fp16) {
    // 1. Setup interfaces
...
TEST_F(AllGatherMatmulV2Tiling, all_gather_matmul_v2_test_basic_small_bf16) {
    // 1. Setup interfaces
    std::string op_type("AllGatherMatmulV2");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(AllGatherMatmulV2Tiling, all_gather_matmul_v2_test_medium_shape_fp16) {
    // 1. Setup interfaces
    std::string op_type("AllGatherMatmulV2");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(AllGatherMatmulV2Tiling, all_gather_matmul_v2_test_large_shape_bf16) {
    // 1. Setup interfaces
    std::string op_type("AllGatherMatmulV2");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    gert::StorageShape gather_output_shape = {{32768, 8192}, {32768, 8192}};
    gert::StorageShape output_shape = {{32768, 16384}, {32768, 16384}};
    gert::StorageShape x1Scale_shape = {{1}, {1}};
    gert::StorageShape x2Scale_shape = {{1}, {1}};
    // 5. Build fake context
    string group("group");
...
TEST_F(AllGatherMatmulV2Tiling, all_gather_matmul_v2_test_boundary_min) {
    // 1. Setup interfaces
    std::string op_type("AllGatherMatmulV2");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(AllGatherMatmulV2Tiling, all_gather_matmul_v2_test_boundary_max) {
    // 1. Setup interfaces
    std::string op_type("AllGatherMatmulV2");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    gert::StorageShape gather_output_shape = {{524280, 65534}, {524280, 65534}};
...
TEST_F(AllGatherMatmulV2Tiling, all_gather_matmul_v2_test_transpose_b) {
    // 1. Setup interfaces
    std::string op_type("AllGatherMatmulV2");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(AllGatherMatmulV2Tiling, all_gather_matmul_v2_test_world_size_2) {
    // 1. Setup interfaces
    std::string op_type("AllGatherMatmulV2");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    auto ws_size = reinterpret_cast<gert::ContinuousVector*>(workspace_size_holer.get());
    // 4. Define input/output shapes (dims 与 storage_dims 对齐)
    gert::StorageShape x1_shape = {{256, 512}, {256, 512}};
    gert::StorageShape x2_shape = {{512, 1024}, {512, 1024}};
    gert::StorageShape gather_output_shape = {{512, 512}, {512, 512}};
    gert::StorageShape output_shape = {{512, 1024}, {512, 1024}};
    gert::StorageShape x1Scale_shape = {{1}, {1}};
    gert::StorageShape x2Scale_shape = {{1}, {1}};
    // 5. Build fake context
    string group("group");
...
TEST_F(AllGatherMatmulV2Tiling, all_gather_matmul_v2_test_world_size_32) {
    // 1. Setup interfaces
    std::string op_type("AllGatherMatmulV2");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    gert::StorageShape output_shape = {{16384, 2048}, {16384, 2048}};
    gert::StorageShape x1Scale_shape = {{1}, {1}};
    gert::StorageShape x2Scale_shape = {{1}, {1}};
    // 5. Build fake context
    string group("group");
...
TEST_F(AllGatherMatmulV2Tiling, all_gather_matmul_v2_test_n_0) {
    // 1. Setup interfaces
    std::string op_type("AllGatherMatmulV2");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    gert::StorageShape x2_shape = {{256, 0}, {256, 0}};
    gert::StorageShape gather_output_shape = {{1024, 256}, {1024, 256}};
    gert::StorageShape output_shape = {{1024, 0}, {1024, 0}};
    gert::StorageShape x1Scale_shape = {{1}, {1}};
    gert::StorageShape x2Scale_shape = {{1}, {1}};
    // 5. Build fake context
    string group("group");
