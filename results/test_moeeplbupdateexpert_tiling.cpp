...
TEST_F(MoeEPLBUpdateExpertTiling, moe_eplb_update_expert_basic_small) {
    // 1. Setup interfaces
...
TEST_F(MoeEPLBUpdateExpertTiling, moe_eplb_update_expert_basic_large) {
    // 1. Setup interfaces
    std::string op_type("MoeEPLBUpdateExpert");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(MoeEPLBUpdateExpertTiling, moe_eplb_update_expert_max_bs) {
    // 1. Setup interfaces
    std::string op_type("MoeEPLBUpdateExpert");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(MoeEPLBUpdateExpertTiling, moe_eplb_update_expert_max_k) {
    // 1. Setup interfaces
    std::string op_type("MoeEPLBUpdateExpert");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(MoeEPLBUpdateExpertTiling, moe_eplb_update_expert_boundary_f) {
    // 1. Setup interfaces
    std::string op_type("MoeEPLBUpdateExpert");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .InputShapes({&expertIds_shape, &eplbTable_shape})
                      .OutputShapes({&balancedExpertIds_shape})
                      .NodeAttrs({{"local_rank_id", ge::AnyValue::CreateFrom<int64_t>(0)}, {"world_size", ge::AnyValue::CreateFrom<int64_t>(64)}, {"balance_mode", ge::AnyValue::CreateFrom<int64_t>(0)}})
                      .CompileInfo(&compile_info)
                      .PlatformInfo(reinterpret_cast<char*>(&platform_info))
                      .NodeInputTd(0, DT_FLOAT16, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeInputTd(1, DT_FLOAT16, ge::FORMAT_ND, ge::FORMAT_ND)
...
TEST_F(MoeEPLBUpdateExpertTiling, moe_eplb_update_expert_min_worldsize) {
    // 1. Setup interfaces
    std::string op_type("MoeEPLBUpdateExpert");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(MoeEPLBUpdateExpertTiling, moe_eplb_update_expert_large_worldsize) {
    // 1. Setup interfaces
    std::string op_type("MoeEPLBUpdateExpert");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(MoeEPLBUpdateExpertTiling, moe_eplb_update_expert_dtype_int64) {
    // 1. Setup interfaces
    std::string op_type("MoeEPLBUpdateExpert");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(MoeEPLBUpdateExpertTiling, moe_eplb_update_expert_edge_case_1) {
    // 1. Setup interfaces
    std::string op_type("MoeEPLBUpdateExpert");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .InputShapes({&expertIds_shape, &eplbTable_shape})
                      .OutputShapes({&balancedExpertIds_shape})
                      .NodeAttrs({{"local_rank_id", ge::AnyValue::CreateFrom<int64_t>(0)}, {"world_size", ge::AnyValue::CreateFrom<int64_t>(4)}, {"balance_mode", ge::AnyValue::CreateFrom<int64_t>(0)}})
                      .CompileInfo(&compile_info)
                      .PlatformInfo(reinterpret_cast<char*>(&platform_info))
                      .NodeInputTd(0, DT_FLOAT16, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeInputTd(1, DT_FLOAT16, ge::FORMAT_ND, ge::FORMAT_ND)
...
TEST_F(MoeEPLBUpdateExpertTiling, moe_eplb_update_expert_edge_case_2) {
    // 1. Setup interfaces
    std::string op_type("MoeEPLBUpdateExpert");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
