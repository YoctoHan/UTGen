...
TEST_F(MatmulReduceScatterTiling, matmul_reduce_scatter_basic_float16) {
    // 1. Setup interfaces
...
TEST_F(MatmulReduceScatterTiling, matmul_reduce_scatter_large_shape) {
    // 1. Setup interfaces
    std::string op_type("MatmulReduceScatter");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    gert::StorageShape output_shape = {{8192, 8192}, {8192, 8192}};
    // 5. Build fake context
    string group("group");
    auto holder = gert::TilingContextFaker()
                        .NodeIoNum(4, 1)
...
TEST_F(MatmulReduceScatterTiling, matmul_reduce_scatter_small_shape) {
    // 1. Setup interfaces
    std::string op_type("MatmulReduceScatter");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    gert::StorageShape output_shape = {{64, 64}, {64, 64}};
    // 5. Build fake context
    string group("group");
    auto holder = gert::TilingContextFaker()
                        .NodeIoNum(4, 1)
...
TEST_F(MatmulReduceScatterTiling, matmul_reduce_scatter_boundary_min) {
    // 1. Setup interfaces
    std::string op_type("MatmulReduceScatter");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    auto ws_size = reinterpret_cast<gert::ContinuousVector*>(workspace_size_holer.get());
    // 4. Define input/output shapes (dims 与 storage_dims 对齐)
    gert::StorageShape x1_shape = {{16, 32}, {16, 32}};
    gert::StorageShape x2_shape = {{32, 16}, {32, 16}};
    gert::StorageShape output_shape = {{16, 16}, {16, 16}};
    // 5. Build fake context
    string group("group");
    auto holder = gert::TilingContextFaker()
                        .NodeIoNum(4, 1)
...
TEST_F(MatmulReduceScatterTiling, matmul_reduce_scatter_boundary_max) {
    // 1. Setup interfaces
    std::string op_type("MatmulReduceScatter");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    auto ws_size = reinterpret_cast<gert::ContinuousVector*>(workspace_size_holer.get());
    // 4. Define input/output shapes (dims 与 storage_dims 对齐)
    gert::StorageShape x1_shape = {{32768, 8192}, {32768, 8192}};
    gert::StorageShape x2_shape = {{8192, 4096}, {8192, 4096}};
    gert::StorageShape output_shape = {{32768, 4096}, {32768, 4096}};
    // 5. Build fake context
    string group("group");
    auto holder = gert::TilingContextFaker()
                        .NodeIoNum(4, 1)
...
TEST_F(MatmulReduceScatterTiling, matmul_reduce_scatter_large_k) {
    // 1. Setup interfaces
    std::string op_type("MatmulReduceScatter");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(MatmulReduceScatterTiling, matmul_reduce_scatter_large_n) {
    // 1. Setup interfaces
    std::string op_type("MatmulReduceScatter");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    gert::StorageShape output_shape = {{512, 8192}, {512, 8192}};
    // 5. Build fake context
    string group("group");
    auto holder = gert::TilingContextFaker()
                        .NodeIoNum(4, 1)
